...
const getBackendUrl = () => {
  ...
  if (!expoUrl) {
    ...
    return "https://mapyourworld.es:3040";
  }
  ...
  try {
    ...
    return 'https://mapyourworld.es:3040';  // Cambia esto según tu entorno de Expo si es necesario
  } catch (error) {
