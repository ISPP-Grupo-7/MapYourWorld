...
import { getDistrictById, getAllDistricts, unlockDistrict, getUserUnlockedDistricts, updateDistrict, getDistrictsByMapId, getUserDistrictsWithColors } from '../controllers/district.controller';
...
router.get('/user/unlock', getUserUnlockedDistricts);
